...
CLASS_DECLARATION( iceWeaponObject, rcWeaponNone )
END_CLASS
...
===============
*/
void rcWeaponNone::Init( idWeapon* weapon )
{
...
===============
*/
stateResult_t rcWeaponNone::Raise( stateParms_t* parms )
{
	enum RisingState
	{
		RISING_NOTSET = 0,
...
===============
*/
stateResult_t rcWeaponNone::Lower( stateParms_t* parms )
{
	enum LoweringState
	{
		LOWERING_NOTSET = 0,
...
===============
*/
stateResult_t rcWeaponNone::Idle( stateParms_t* parms )
{
	enum IdleState
	{
		IDLE_NOTSET = 0,
...
===============
*/
stateResult_t rcWeaponNone::Fire( stateParms_t* parms )
{
...
===============
*/
stateResult_t rcWeaponNone::Reload( stateParms_t* parms )
{
	enum RELOAD_State
	{
		RELOAD_NOTSET = 0,
