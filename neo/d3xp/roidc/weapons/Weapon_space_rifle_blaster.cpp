...
CLASS_DECLARATION( iceWeaponObject, rcWeaponRifleBlaster )
END_CLASS
...
/*
===============
rcWeaponRifleBlaster::Init
===============
*/
void rcWeaponRifleBlaster::Init( idWeapon* weapon )
{
...
/*
===============
rcWeaponRifleBlaster::Raise
===============
*/
stateResult_t rcWeaponRifleBlaster::Raise( stateParms_t* parms )
{
	enum RisingState
	{
		RISING_NOTSET = 0,
...
/*
===============
rcWeaponRifleBlaster::Lower
===============
*/
stateResult_t rcWeaponRifleBlaster::Lower( stateParms_t* parms )
{
	enum LoweringState
	{
		LOWERING_NOTSET = 0,
...
/*
===============
rcWeaponRifleBlaster::Idle
===============
*/
stateResult_t rcWeaponRifleBlaster::Idle( stateParms_t* parms )
{
	enum IdleState
	{
		IDLE_NOTSET = 0,
...
/*
===============
rcWeaponRifleBlaster::Fire
===============
*/
stateResult_t rcWeaponRifleBlaster::Fire( stateParms_t* parms )
{
...
/*
===============
rcWeaponRifleBlaster::Reload
===============
*/
stateResult_t rcWeaponRifleBlaster::Reload( stateParms_t* parms )
{
	enum RELOAD_State
	{
		RELOAD_NOTSET = 0,
